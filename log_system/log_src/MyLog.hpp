...
#ifndef ASYNCLOG_CLOUDSTORAGE_MYLOG_HPP
#define ASYNCLOG_CLOUDSTORAGE_MYLOG_HPP
#pragma once
#include "Manager.hpp"

namespace mylog {
inline AsyncLogger::ptr GetLogger(const std::string &logger_name) {
...
#endif // ASYNCLOG_CLOUDSTORAGE_MYLOG_HPP
